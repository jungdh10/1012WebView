package com.example.a503_14.a1012webview;
...
public class HybridApp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //첫 번째 매개변수는 메소드의 위치를 알려주는 것이고
        //두 번째 매개변수는 html에서 호출할 때 사용할 인스턴스 이름
        webView.addJavascriptInterface(new AndroidJavascriptInterface(this), "MYAPP");
        //url 로딩
        webView.loadUrl("http://192.168.0.250:8080/mobileweb/hybridapp");
        //버튼의 클릭 이벤트 처리
        ...
        sendmsg.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(HybridApp.this, "javascript:showDisplayMessage('"+ message.getText().toString()+"')", Toast.LENGTH_LONG).show();
                //자바스크립트 함수 호출
